...
<head>
  ...
  $cssFile = $base . '/0.invitación/style.css';
  $jsFile  = $base . '/0.invitación/app.js';
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="../0.invitación/style.css<?= $cssVer ? '?v=' . $cssVer : '' ?>">
  ...
  <!-- JS -->
  <script defer src="../0.invitación/app.js<?= $jsVer ? '?v=' . $jsVer : '' ?>"></script>
</head>
<body>
