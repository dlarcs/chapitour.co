...
<head>
  ...
  <meta name="twitter:image" content="https://www.chapitour.co/bar/Gran&Chela_Club/img/general18.jpg">
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="../../../bar/Gran&Chela_Club/actividades/style.css<?= $cssVer ? '?v=' . $cssVer : '' ?>">
...
<body>
  ...
  <?php include "../../../bar/Gran&Chela_Club/global/pag_nav/pag_nav.php" ?>
  <div class="container_reservas">
    <?php include "../../../bar/Gran&Chela_Club/actividades/actividades/actividades.php" ?>

  </div>
  <?php include "../../../bar/Gran&Chela_Club/global/boton/boton.php" ?>
  <?php include "../../../bar/Gran&Chela_Club/global/pag_footer/pag_footer.php" ?>
