...
<link rel="stylesheet" href="../../../bar/Gran&Chela_Club/reservas/reservas/reservas.css<?= $cssVer ? '?v=' . $cssVer : '' ?>">
...
<!--
  ...
  <!-- <div class="food-box" id="foodBox">
    ...
    <a  href="../../../bar/Gran&Chela_Club/index.php" class="btn btn30">
      Pagar anticipo
    </a> -->
...
<script defer src="../../../bar/Gran&Chela_Club/reservas/reservas/reservas.js<?= $jsVer ? '?v=' . $jsVer : '' ?>"></script>
