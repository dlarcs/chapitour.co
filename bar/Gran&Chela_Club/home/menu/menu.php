  ...
  <div class="menu-grid">
    ...
    <article class="menu-card">
      <video class="menu-card-video" muted loop playsinline preload="metadata">
        <source src="../../bar/Gran&Chela_Club/img/video.mp4#t=0.2" type="video/mp4">
      </video>
    ...
    <article class="menu-card">
      <video class="menu-card-video" muted loop playsinline preload="metadata">
        <source src="../../bar/Gran&Chela_Club/img/video1.mp4#t=0.2" type="video/mp4">
      </video>
    ...
    <article class="menu-card">
      <video class="menu-card-video" muted loop playsinline preload="metadata">
        <source src="../../bar/Gran&Chela_Club/img/video2.mp4#t=0.2" type="video/mp4">
      </video>
    ...
    <article class="menu-card">
      <video class="menu-card-video" muted loop playsinline preload="metadata">
        <source src="../../bar/Gran&Chela_Club/img/video3.mp4#t=0.2" type="video/mp4">
      </video>
