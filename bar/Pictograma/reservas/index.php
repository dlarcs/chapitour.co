...
<head>
  ...
  <title>Reservas | Pictogramas Cafe Bar</title>

  <?php
  $base = rtrim($_SERVER['DOCUMENT_ROOT'], '/');

  $cssFile = $base . '/bar/Pictograma/reservas/style.css';
  ...
  <link
    rel="canonical"
    href="https://www.chapitour.co/bar/Pictograma/reservas/index.php"
  >
  ...
  <meta
    property="og:title"
    content="Reservas | Pictogramas Cafe Bar"
  >

  <meta
    property="og:description"
    content="Reserva en Pictogramas Cafe Bar y disfruta cócteles, micheladas, granizados, cervezas, café y bolirana en un ambiente ideal para compartir con amigos."
  >

  <meta
    property="og:url"
    content="https://www.chapitour.co/bar/Pictograma/reservas/index.php"
  >
  ...
  <meta
    ...
    content="Reserva en Pictogramas Cafe Bar y disfruta bebidas, amigos, buena energía y divertidas partidas de bolirana."
  >
  ...
  <link
    rel="stylesheet"
    href="../../../bar/Pictograma/reservas/style.css<?= $cssVer ? '?v=' . $cssVer : '' ?>"
  >
  ...
  <script type="application/ld+json">
  {
    ...
    "@graph": [
      ...
      {
        "@type": "WebPage",
        "@id": "https://www.chapitour.co/bar/Pictograma/reservas/index.php#webpage",
        "url": "https://www.chapitour.co/bar/Pictograma/reservas/index.php",
        "name": "Reservas | Pictogramas Cafe Bar",
        "description": "Página de reservas de Pictogramas Cafe Bar, un lugar para disfrutar bebidas, café, amigos y partidas de bolirana en Chapinero.",
        "inLanguage": "es-CO",
        "isPartOf": {
          "@id": "https://www.chapitour.co/#website"
        },
...
<body>
  ...
  <div class="container_reservas">
    <?php include "../../../bar/Pictograma/reservas/reservas/reservas.php"; ?>
  </div>
