...
$cssFile = $base . '/bar/Pictograma/home/nav/nav.css';
$jsFile  = $base . '/bar/Pictograma/home/nav/nav.js';

$cssVer = is_file($cssFile) ? filemtime($cssFile) : '';
$jsVer  = is_file($jsFile) ? filemtime($jsFile) : '';
?>

<link rel="stylesheet" href="../../bar/Pictograma/home/nav/nav.css<?= $cssVer ? '?v=' . $cssVer : '' ?>">

<header class="chapitour-header">
  <a href="../../bar/Pictograma/index.php" class="chapitour-logo" aria-label="Ir al inicio">
    <h1>Pictogramas Café Bar</h1>
  </a>
...
<script defer src="../../bar/Pictograma/home/nav/nav.js<?= $jsVer ? '?v=' . $jsVer : '' ?>"></script>
