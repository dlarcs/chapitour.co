...
<head>
  ...
  $cssFile = $base . '/bar/CapitalQueer/menu/style.css';
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="../../../bar/CapitalQueer/menu/style.css<?= $cssVer ? '?v=' . $cssVer : '' ?>">
...
<body>
  ...
  <div class="container_menu">
    <?php include "../../../bar/CapitalQueer/menu/menu/menu.php" ?>
  </div>
