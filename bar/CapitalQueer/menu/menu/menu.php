...
$cssFile = $base . '/bar/CapitalQueer/menu/menu/menu.css';
$jsFile  = $base . '/bar/CapitalQueer/menu/menu/menu.js';

$cssVer = is_file($cssFile) ? filemtime($cssFile) : '';
$jsVer  = is_file($jsFile) ? filemtime($jsFile) : '';
?>

<link rel="stylesheet" href="../../../bar/CapitalQueer/menu/menu/menu.css<?= $cssVer ? '?v=' . $cssVer : '' ?>">
...
<script defer src="../../../bar/CapitalQueer/menu/menu/menu.js<?= $jsVer ? '?v=' . $jsVer : '' ?>"></script>
