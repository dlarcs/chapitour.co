...
<link rel="stylesheet" href="../../bar/CapitalQueer/home/galeria/galeria.css<?= $cssVer ? '?v=' . $cssVer : '' ?>">
...
<section class="business-section business-gallery visible">
  ...
  <a href="../../bar/CapitalQueer/galeria/index.php">
...
<script defer src="../../bar/CapitalQueer/home/galeria/galeria.js<?= $jsVer ? '?v=' . $jsVer : '' ?>"></script>
