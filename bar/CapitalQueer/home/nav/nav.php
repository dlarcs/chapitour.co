...
$cssFile = $base . '/bar/CapitalQueer/home/nav/nav.css';
$jsFile  = $base . '/bar/CapitalQueer/home/nav/nav.js';

$cssVer = is_file($cssFile) ? filemtime($cssFile) : '';
$jsVer  = is_file($jsFile) ? filemtime($jsFile) : '';
?>

<link rel="stylesheet" href="../../bar/CapitalQueer/home/nav/nav.css<?= $cssVer ? '?v=' . $cssVer : '' ?>">
...
<header class="chapitour-header">
  ...
  <nav id="chapitour-menu" class="chapitour-menu" aria-label="Menú principal">
    <div class="menu-inner">
      <a href="../../bar/CapitalQueer/menu/index.php">Menú</a>
      <a href="../../bar/CapitalQueer/galeria/index.php">Galería</a>
      <a href="../../bar/CapitalQueer/reservas/index.php">Reservas</a>
...
<script defer src="../../bar/CapitalQueer/home/nav/nav.js<?= $jsVer ? '?v=' . $jsVer : '' ?>"></script>
