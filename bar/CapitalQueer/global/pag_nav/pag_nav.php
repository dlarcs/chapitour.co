...
<header class="chapitour-header">
  ...
  <nav id="chapitour-menu" class="chapitour-menu" aria-label="Menú principal">
    <div class="menu-inner">
      ...
      <a href="../../../bar/CapitalQueer/index.php#acerca_nosotros">Nosotros</a>
      <a href="../../../bar/CapitalQueer/index.php#redes_sociales">Redes sociales</a>
      <a href="../../../bar/CapitalQueer/index.php#ubicacion">Ubicación</a>
