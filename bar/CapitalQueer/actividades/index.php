...
<head>
  ...
  <meta name="twitter:image" content="https://www.chapitour.co/bar/CapitalQueer/img/general18.png">
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="../../../bar/CapitalQueer/actividades/style.css<?= $cssVer ? '?v=' . $cssVer : '' ?>">
