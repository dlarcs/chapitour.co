...
<link rel="stylesheet" href="../../../bar/CapitalQueer/galeria/galeria/galeria.css<?= $cssVer ? '?v=' . $cssVer : '' ?>">
...
<script defer src="../../../bar/CapitalQueer/galeria/galeria/galeria.js<?= $jsVer ? '?v=' . $jsVer : '' ?>"></script>
