...
$cssFile = $base . '/juegos/JimarFactory/home/nav/nav.css';
$jsFile  = $base . '/juegos/JimarFactory/home/nav/nav.js';

$cssVer = is_file($cssFile) ? filemtime($cssFile) : '';
$jsVer  = is_file($jsFile) ? filemtime($jsFile) : '';
?>

<link rel="stylesheet" href="../../juegos/JimarFactory/home/nav/nav.css<?= $cssVer ? '?v=' . $cssVer : '' ?>">
...
<script defer src="../../juegos/JimarFactory/home/nav/nav.js<?= $jsVer ? '?v=' . $jsVer : '' ?>"></script>
