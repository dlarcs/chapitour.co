...
<link rel="stylesheet" href="../../../juegos/JimarFactory/menu/menu/menu.css<?= $cssVer ? '?v=' . $cssVer : '' ?>">
...
<script defer src="../../../juegos/JimarFactory/menu/menu/menu.js<?= $jsVer ? '?v=' . $jsVer : '' ?>"></script>
