...
<link rel="stylesheet" href="../../../juegos/JimarFactory/reservas/reservas/reservas.css<?= $cssVer ? '?v=' . $cssVer : '' ?>">
...
<!--
  ...
  <!-- <div class="food-box" id="foodBox">
    ...
    <a  href="../../../juegos/JimarFactory/index.php" class="btn btn30">
      Pagar anticipo
    </a> -->
...
<script defer src="../../../juegos/JimarFactory/reservas/reservas/reservas.js<?= $jsVer ? '?v=' . $jsVer : '' ?>"></script>
