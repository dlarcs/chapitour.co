...
<head>
  ...
  $cssFile = $base . '/juegos/JilmarFactory/actividades/style.css';
  ...
  <meta name="twitter:image" content="https://www.chapitour.co/juegos/JilmarFactory/img/general11.jpg">
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="../../../juegos/JilmarFactory/actividades/style.css<?= $cssVer ? '?v=' . $cssVer : '' ?>">
...
<body>
  ...
  <div class="container_reservas">
    <?php include "../../../juegos/JilmarFactory/actividades/actividades/actividades.php" ?>
