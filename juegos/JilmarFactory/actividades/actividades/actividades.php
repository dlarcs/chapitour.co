...
$cssFile = $base . '/juegos/JilmarFactory/actividades/actividades/actividades.css';
$jsFile  = $base . '/juegos/JilmarFactory/actividades/actividades/actividades.js';

$cssVer = is_file($cssFile) ? filemtime($cssFile) : '';
$jsVer  = is_file($jsFile) ? filemtime($jsFile) : '';
?>

<link rel="stylesheet" href="../../../juegos/JilmarFactory/actividades/actividades/actividades.css<?= $cssVer ? '?v=' . $cssVer : '' ?>">
    ...
    <div class="cards-grid">
      ...
      <article class="card promo-card" data-code="GARAGE-KARAOKE-001">
        <div class="card-image">
          <img src="../../../juegos/JilmarFactory/img/general15.jpg" alt="Noche de karaoke en Garage Disco Bar">
      ...
      <article class="card promo-card" data-code="GARAGE-CROSSOVER-002">
        <div class="card-image">
          <img src="../../../juegos/JilmarFactory/img/general13.jpg" alt="Fiesta crossover en Garage Disco Bar">
      ...
      <article class="card promo-card" data-code="GARAGE-SHOWS-003">
        <div class="card-image">
          <img src="../../../juegos/JilmarFactory/img/general17.jpg" alt="Shows especiales en Garage Disco Bar">
      ...
      <article class="card promo-card" data-code="GARAGE-GASTROBAR-004">
        <div class="card-image">
          <img src="../../../juegos/JilmarFactory/img/general6.jpg" alt="Comida y bebidas en Garage Disco Bar">
      ...
      <article class="card promo-card" data-code="GARAGE-DISCOBAR-005">
        <div class="card-image">
          <img src="../../../juegos/JilmarFactory/img/general1.jpg" alt="Ambiente de fiesta en Garage Disco Bar">
      ...
      <article class="card promo-card" data-code="GARAGE-BAILE-006">
        <div class="card-image">
          <img src="../../../juegos/JilmarFactory/img/general10.jpg" alt="Noche de baile en Garage Disco Bar">
...
<script defer src="../../../juegos/JilmarFactory/actividades/actividades/actividades.js<?= $jsVer ? '?v=' . $jsVer : '' ?>"></script>
