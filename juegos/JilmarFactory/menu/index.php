...
<head>
  ...
  $cssFile = $base . '/juegos/JilmarFactory/menu/style.css';
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="../../../juegos/JilmarFactory/menu/style.css<?= $cssVer ? '?v=' . $cssVer : '' ?>">
...
<body>
  ...
  <div class="container_menu">
    <?php include "../../../juegos/JilmarFactory/menu/menu/menu.php" ?>
  </div>
