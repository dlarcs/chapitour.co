...
$cssFile = $base . '/juegos/JilmarFactory/global/pag_nav/pag_nav.css';
$jsFile  = $base . '/juegos/JilmarFactory/global/pag_nav/pag_nav.js';

$cssVer = is_file($cssFile) ? filemtime($cssFile) : '';
$jsVer  = is_file($jsFile) ? filemtime($jsFile) : '';
?>

<link rel="stylesheet" href="../../../juegos/JilmarFactory/global/pag_nav/pag_nav.css<?= $cssVer ? '?v=' . $cssVer : '' ?>">
...
<header class="chapitour-header">
  ...
  <nav id="chapitour-menu" class="chapitour-menu" aria-label="Menú principal">
    <div class="menu-inner">
      ...
      <a href="../../../juegos/JilmarFactory/index.php#acerca_nosotros">Nosotros</a>
      <a href="../../../juegos/JilmarFactory/index.php#redes_sociales">Redes sociales</a>
      <a href="../../../juegos/JilmarFactory/index.php#ubicacion">Ubicación</a>
...
<script defer src="../../../juegos/JilmarFactory/global/pag_nav/pag_nav.js<?= $jsVer ? '?v=' . $jsVer : '' ?>"></script>
