...
<head>
  ...
  $cssFile = $base . '/juegos/JilmarFactory/galeria/style.css';
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="../../../juegos/JilmarFactory/galeria/style.css<?= $cssVer ? '?v=' . $cssVer : '' ?>">
...
<body>
  ...
  <div class="container_galeria">
    <?php include "../../../juegos/JilmarFactory/galeria/galeria/galeria.php" ?>
