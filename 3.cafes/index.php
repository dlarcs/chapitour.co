...
<head>
  ...
  $cssFile = $base . '/3.cafes/style.css';
  $jsFile  = $base . '/3.cafes/app.js';
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="../3.cafes/style.css<?= $cssVer ? '?v=' . $cssVer : '' ?>">
  ...
  <!-- JS -->
  <script defer src="../3.cafes/app.js<?= $jsVer ? '?v=' . $jsVer : '' ?>"></script>
</head>
...
<body>
  ...
  <?php include "../3.cafes/seccion/cafes.php" ?>
