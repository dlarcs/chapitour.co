...
<head>
  ...
  $cssFile = $base . '/7.gastronomia/style.css';
  $jsFile  = $base . '/7.gastronomia/app.js';
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="../7.gastronomia/style.css<?= $cssVer ? '?v=' . $cssVer : '' ?>">
  ...
  <!-- JS -->
  <script defer src="../7.gastronomia/app.js<?= $jsVer ? '?v=' . $jsVer : '' ?>"></script>
</head>
<body>
  ...
  <?php include "../7.gastronomia/seccion/gastronomia.php" ?>
