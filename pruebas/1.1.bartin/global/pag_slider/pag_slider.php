...
$cssFile = $base . '/1.1.bartin/global/pag_slider/pag_slider.css';
$jsFile  = $base . '/1.1.bartin/global/pag_slider/pag_slider.js';

$cssVer = is_file($cssFile) ? filemtime($cssFile) : '';
$jsVer  = is_file($jsFile) ? filemtime($jsFile) : '';
?>

<link rel="stylesheet" href="../../1.1.bartin/global/pag_slider/pag_slider.css<?= $cssVer ? '?v=' . $cssVer : '' ?>">
...
<script defer src="../../1.1.bartin/global/pag_slider/pag_slider.js<?= $jsVer ? '?v=' . $jsVer : '' ?>"></script>
