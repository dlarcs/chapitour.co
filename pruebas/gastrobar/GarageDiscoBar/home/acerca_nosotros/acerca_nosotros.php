...
$cssFile = $base . '/gastrobar/GarageDiscoBar/home/acerca_nosotros/acerca_nosotros.css';
$jsFile  = $base . '/gastrobar/GarageDiscoBar/home/acerca_nosotros/acerca_nosotros.js';

$cssVer = is_file($cssFile) ? filemtime($cssFile) : '';
$jsVer  = is_file($jsFile) ? filemtime($jsFile) : '';
?>

<link rel="stylesheet" href="../../gastrobar/GarageDiscoBar/home/acerca_nosotros/acerca_nosotros.css<?= $cssVer ? '?v=' . $cssVer : '' ?>">
...
<section class="business-section business-about visible" id="acerca_nosotros">
  ...
  <img src="../../gastrobar/GarageDiscoBar/img/general11.jpg" alt="Experiencia en Capital Queer">

</section>

<a href="../../gastrobar/GarageDiscoBar/reservas/index.php">
  <div class="button_container">
    <button class="btn btn30" type="button" name="button">Reservas</button>
  </div>
</a>

<script defer src="../../gastrobar/GarageDiscoBar/home/acerca_nosotros/acerca_nosotros.js<?= $jsVer ? '?v=' . $jsVer : '' ?>"></script>
