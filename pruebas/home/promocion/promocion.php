...
<button class="chapi-promo-launcher chapi-promo-launcher--demo" id="chapi-promo-demo-launcher" type="button" aria-haspopup="dialog" aria-controls="chapi-promo-demo" hidden>
  <span aria-hidden="true">✳</span> Ver promoción otra vez <small>DEMO</small>
</button>
  ...
  <div class="chapi-promo__shell">
    ...
    <section class="chapi-promo__screen" data-promo-screen="wheel">
      <div class="chapi-promo__intro">
        ...
        <p class="chapi-promo__micro" id="chapi-promo-spin-status" role="status">Sin registro. Solo buenos planes.</p>
      </div>
    ...
    <section class="chapi-promo__screen chapi-promo__result" data-promo-screen="result" hidden aria-labelledby="chapi-promo-result-title">
      ...
      <div class="chapi-promo__result-intro">
        ...
        <div class="chapi-promo__venue"><img id="chapi-promo-logo" alt="" width="60" height="60"><div><small id="chapi-promo-category"></small><h3 id="chapi-promo-business"></h3><p id="chapi-promo-description"></p></div></div>
        <label class="chapi-promo__history" id="chapi-promo-history-label" hidden>Mis promociones<select id="chapi-promo-history"></select></label><p class="chapi-promo__save-hint"><span aria-hidden="true">▣</span> Guarda un pantallazo de tu premio y presenta el código al llegar. El establecimiento validará su vigencia.</p>
      ...
      <div class="chapi-promo__ticket">
        ...
        <p class="chapi-promo__expiry" id="chapi-promo-expiry"></p>
        <a class="chapi-promo__button chapi-promo__button--green" id="chapi-promo-claim" target="_blank" rel="noopener noreferrer"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M20.5 11.7a8.5 8.5 0 0 1-12.6 7.5L3 20.5l1.3-4.7a8.5 8.5 0 1 1 16.2-4.1Z"/><path d="M8 7.5c-.8.8-.3 2.6 1.4 4.3s3.5 2.2 4.3 1.4l1.3-1.3-2-1-1 1c-1.1-.5-2-1.4-2.5-2.5l1-1-1-2Z"/></svg><span>Reclamar por WhatsApp</span><span aria-hidden="true">↗</span></a>
        <p class="chapi-promo__conditions" id="chapi-promo-conditions"></p><p class="chapi-promo__micro" id="chapi-promo-copy-status" role="status"></p><button class="chapi-promo__button chapi-promo__button--pink" type="button" id="chapi-promo-use-opportunity" hidden>Usar mi nueva oportunidad ↗</button>
      </div>
      <div class="chapi-promo__another"><div><span aria-hidden="true">✳</span><p>Los buenos planes se comparten.<small id="chapi-promo-invite-description">Invita a 5 amigos y desbloquea otra oportunidad.</small></p></div><button type="button" id="chapi-promo-invite">Quiero volver a tener una oportunidad de un descuento <span aria-hidden="true">→</span></button></div>
    </section>
    ...
    <section class="chapi-promo__screen chapi-promo__share" data-promo-screen="share" hidden aria-labelledby="chapi-promo-share-title">
      ...
      <div class="chapi-promo__share-layout"><div>
        ...
        <p class="chapi-promo__description" id="chapi-promo-share-description">Comparte tu enlace por WhatsApp. Cuando 5 visitantes distintos entren y confirmen su visita tendrás otro giro.</p>
        ...
        <div class="chapi-promo__progress-heading"><span>TU PRÓXIMA OPORTUNIDAD</span><strong id="chapi-promo-invite-count">0 <small>/ 5</small></strong></div>
        <div class="chapi-promo__friends" id="chapi-promo-friends" aria-hidden="true"></div>
        <div class="chapi-promo__progress" role="progressbar" aria-label="Visitas referidas válidas" aria-valuemin="0" aria-valuemax="5" aria-valuenow="0"><span id="chapi-promo-progress-fill"></span></div>
    ...
    <footer class="chapi-promo__footer"><p><span aria-hidden="true">◌</span> Sin registro · Conserva las cookies para guardar tu progreso</p><span>HECHO PARA VIVIR CHAPINERO ↗</span></footer>
