...
<head>
  ...
  $cssFile = $base . '/categorias/2.planes_bares/style.css';
  $jsFile  = $base . '/categorias/2.planes_bares/app.js';
  ...
  <link rel="canonical" href="https://www.chapitour.co/categorias/1.planes_bares/">
  ...
  <meta property="og:url" content="https://www.chapitour.co/categorias/1.planes_bares/">
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="../../categorias/2.planes_bares/style.css<?= $cssVer ? '?v=' . $cssVer : '' ?>">
  ...
  <script type="application/ld+json">
  {
    ...
    "@graph": [
      ...
      {
        "@type": "ItemList",
        "@id": "https://www.chapitour.co/categorias/1.planes_bares/#bares",
        ...
        "url": "https://www.chapitour.co/categorias/1.planes_bares/",
  ...
  <!-- JS -->
  <script defer src="../../categorias/2.planes_bares/app.js<?= $jsVer ? '?v=' . $jsVer : '' ?>"></script>
</head>

<body>
  <?php include "../../global/menu/menu.php" ?>
  <?php include "../../categorias/2.planes_bares/seccion/planes_bares.php" ?>
