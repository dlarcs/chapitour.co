...
<head>
  ...
  $cssFile = $base . '/categorias/category/style.css';
  $jsFile  = $base . '/categorias/category/app.js';
  ...
  <link rel="canonical" href="https://www.chapitour.co/categorias/category/">
  ...
  <meta property="og:url" content="https://www.chapitour.co/categorias/category/">
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="../../categorias/category/style.css<?= $cssVer ? '?v=' . $cssVer : '' ?>">
  ...
  <script type="application/ld+json">
  {
    ...
    "@graph": [
      {
        "@type": "WebPage",
        "@id": "https://www.chapitour.co/categorias/category/#webpage",
        "name": "Categorías en Chapitour",
        "url": "https://www.chapitour.co/categorias/category/",
        "inLanguage": "es-CO",
        "description": "Página de categorías de Chapitour para explorar lugares, planes y experiencias en Chapinero, Bogotá."
      },
      {
        "@type": "ItemList",
        "@id": "https://www.chapitour.co/categorias/category/#categories",
  ...
  <!-- JS -->
  <script defer src="../../categorias/category/app.js<?= $jsVer ? '?v=' . $jsVer : '' ?>"></script>
</head>
...
<body>
  ...
  <?php include "../../categorias/category/seccion/categoria.php" ?>
