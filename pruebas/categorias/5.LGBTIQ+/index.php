...
<head>
  ...
  $cssFile = $base . '/categorias/5.LGBTIQ+/style.css';
  $jsFile  = $base . '/categorias/5.LGBTIQ+/app.js';
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="../../categorias/5.LGBTIQ+/style.css<?= $cssVer ? '?v=' . $cssVer : '' ?>">
  ...
  <!-- JS -->
  <script defer src="../../categorias/5.LGBTIQ+/app.js<?= $jsVer ? '?v=' . $jsVer : '' ?>"></script>
</head>
<body>
  ...
  <?php include "../../categorias/5.LGBTIQ+/seccion/LGBTIQ+.php" ?>
