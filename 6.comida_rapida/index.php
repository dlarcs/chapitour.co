...
<head>
  ...
  $cssFile = $base . '/6.comida_rapida/style.css';
  $jsFile  = $base . '/6.comida_rapida/app.js';
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="../6.comida_rapida/style.css<?= $cssVer ? '?v=' . $cssVer : '' ?>">
  ...
  <!-- JS -->
  <script defer src="../6.comida_rapida/app.js<?= $jsVer ? '?v=' . $jsVer : '' ?>"></script>
</head>
<body>
  ...
  <?php include "../6.comida_rapida/seccion/comida_rapida.php" ?>
