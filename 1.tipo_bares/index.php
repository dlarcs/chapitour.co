...
<head>
  ...
  $cssFile = $base . '/1.tipo_bares/style.css';
  $jsFile  = $base . '/1.tipo_bares/app.js';
  ...
  <link rel="canonical" href="https://www.chapitour.co/1.tipo_bares/">
  ...
  <meta property="og:url" content="https://www.chapitour.co/1.tipo_bares/">
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="../1.tipo_bares/style.css<?= $cssVer ? '?v=' . $cssVer : '' ?>">
  ...
  <script type="application/ld+json">
  {
    ...
    "@graph": [
      ...
      {
        "@type": "ItemList",
        "@id": "https://www.chapitour.co/1.tipo_bares/#tipos-de-bares",
        ...
        "url": "https://www.chapitour.co/1.tipo_bares/",
  ...
  <!-- JS -->
  <script defer src="../1.tipo_bares/app.js<?= $jsVer ? '?v=' . $jsVer : '' ?>"></script>
</head>
...
<body>
  ...
  <?php include "../1.tipo_bares/seccion/tipo_bares.php" ?>
