...
<head>
  ...
  $cssFile = $base . '/categorias/9.panaderia/style.css';
  $jsFile  = $base . '/categorias/9.panaderia/app.js';
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="../../categorias/9.panaderia/style.css<?= $cssVer ? '?v=' . $cssVer : '' ?>">
  ...
  <!-- JS -->
  <script defer src="../../categorias/9.panaderia/app.js<?= $jsVer ? '?v=' . $jsVer : '' ?>"></script>
</head>
<body>
  ...
  <?php include "../../categorias/9.panaderia/seccion/panaderia.php" ?>
