...
<head>
  ...
  $cssFile = $base . '/categorias/10.destacados/style.css';
  $jsFile  = $base . '/categorias/10.destacados/app.js';
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="../../categorias/10.destacados/style.css<?= $cssVer ? '?v=' . $cssVer : '' ?>">
  ...
  <!-- JS -->
  <script defer src="../../categorias/10.destacados/app.js<?= $jsVer ? '?v=' . $jsVer : '' ?>"></script>
</head>
...
<body>
  ...
  <?php include "../../categorias/10.destacados/seccion/destacado.php" ?>
