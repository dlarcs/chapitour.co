...
<head>
  ...
  $cssFile = $base . '/categorias/8.artesanias/style.css';
  $jsFile  = $base . '/categorias/8.artesanias/app.js';
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="../../categorias/8.artesanias/style.css<?= $cssVer ? '?v=' . $cssVer : '' ?>">
  ...
  <!-- JS -->
  <script defer src="../../categorias/8.artesanias/app.js<?= $jsVer ? '?v=' . $jsVer : '' ?>"></script>
</head>
<body>
  ...
  <?php include "../../categorias/8.artesanias/seccion/artesanias.php" ?>
