...
<head>
  ...
  $cssFile = $base . '/4.postres/style.css';
  $jsFile  = $base . '/4.postres/app.js';
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="../4.postres/style.css<?= $cssVer ? '?v=' . $cssVer : '' ?>">
  ...
  <!-- JS -->
  <script defer src="../4.postres/app.js<?= $jsVer ? '?v=' . $jsVer : '' ?>"></script>
</head>
...
<body>
  ...
  <?php include "../4.postres/seccion/postres.php" ?>
