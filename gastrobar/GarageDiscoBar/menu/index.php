...
<head>
  ...
  $cssFile = $base . '/gastrobar/GarageDiscoBar/menu/style.css';
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="../../../gastrobar/GarageDiscoBar/menu/style.css<?= $cssVer ? '?v=' . $cssVer : '' ?>">
...
<body>
  ...
  <div class="container_menu">
    <?php include "../../../gastrobar/GarageDiscoBar/menu/menu/menu.php" ?>
  </div>
