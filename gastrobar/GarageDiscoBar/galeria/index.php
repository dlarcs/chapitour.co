...
<head>
  ...
  $cssFile = $base . '/gastrobar/GarageDiscoBar/galeria/style.css';
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="../../../gastrobar/GarageDiscoBar/galeria/style.css<?= $cssVer ? '?v=' . $cssVer : '' ?>">
...
<body>
  ...
  <div class="container_galeria">
    <?php include "../../../gastrobar/GarageDiscoBar/galeria/galeria/galeria.php" ?>
