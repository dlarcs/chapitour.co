...
<head>
  ...
  $cssFile = $base . '/gastrobar/GarageDiscoBar/actividades/style.css';
  ...
  <meta name="twitter:image" content="https://www.chapitour.co/gastrobar/GarageDiscoBar/img/general11.jpg">
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="../../../gastrobar/GarageDiscoBar/actividades/style.css<?= $cssVer ? '?v=' . $cssVer : '' ?>">
...
<body>
  ...
  <div class="container_reservas">
    <?php include "../../../gastrobar/GarageDiscoBar/actividades/actividades/actividades.php" ?>
