...
$cssFile = $base . '/gastrobar/Garage9-39C/actividades/actividades/actividades.css';
$jsFile  = $base . '/gastrobar/Garage9-39C/actividades/actividades/actividades.js';

$cssVer = is_file($cssFile) ? filemtime($cssFile) : '';
$jsVer  = is_file($jsFile) ? filemtime($jsFile) : '';
?>

<link rel="stylesheet" href="../../../gastrobar/Garage9-39C/actividades/actividades/actividades.css<?= $cssVer ? '?v=' . $cssVer : '' ?>">
    ...
    <div class="cards-grid">
      ...
      <article class="card promo-card" data-code="CAPITAL-AMOR-AMISTAD-001">
        <div class="card-image">
          <img src="../../../gastrobar/Garage9-39C/img/general15.jpg" alt="Amor y amistad">
      ...
      <article class="card promo-card" data-code="CAPITAL-HALLOWEEN-002">
        <div class="card-image">
          <img src="../../../gastrobar/Garage9-39C/img/general13.jpg" alt="Halloween">
      ...
      <article class="card promo-card" data-code="CAPITAL-VELITAS-003">
        <div class="card-image">
          <img src="../../../gastrobar/Garage9-39C/img/general17.jpg" alt="Día de velitas">
      ...
      <article class="card promo-card" data-code="CAPITAL-NAVIDAD-004">
        <div class="card-image">
          <img src="../../../gastrobar/Garage9-39C/img/general6.jpg" alt="Navidad">
      ...
      <article class="card promo-card" data-code="CAPITAL-FIN-DE-ANO-005">
        <div class="card-image">
          <img src="../../../gastrobar/Garage9-39C/img/general1.jpg" alt="Fin de año">
      ...
      <article class="card promo-card" data-code="CAPITAL-VIERNES-006">
        <div class="card-image">
          <img src="../../../gastrobar/Garage9-39C/img/general10.jpg" alt="Viernes de amigas">
...
<script defer src="../../../gastrobar/Garage9-39C/actividades/actividades/actividades.js<?= $jsVer ? '?v=' . $jsVer : '' ?>"></script>
